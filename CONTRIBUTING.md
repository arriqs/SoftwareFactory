...
This is a fork of [cline/kanban](https://github.com/cline/kanban). We may occasionally cherry-pick useful changes from upstream, but fork syncing is not a priority. Feel free to modify any file in the codebase — there are no restrictions on editing upstream-originated files.

### Set `gh` default to the fork
